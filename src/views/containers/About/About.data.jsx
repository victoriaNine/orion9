...
const data = [
  {
    ...
    text: "React, Preact, Backbone, Webpack, RequireJS, Grunt, lodash, jQuery, PostCSS, SASS, Greensock, Canvas, WebAudio API, Gamepad API, Socket.io, CouchDB, Node.js, Git, Framework development, ES2017+, Photoshop, Illustrator, Audio"
  },
  {
