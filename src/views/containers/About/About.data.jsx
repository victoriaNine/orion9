  ...
  sections: [
    {
      ...
      text: "HTML5, CSS3, ES2017+, PostCSS, SASS, Greensock, Canvas, WebAudio API, Tone.js, Gamepad API, jQuery, React, Preact, Backbone, Webpack, RequireJS, Grunt, lodash, Jest, Enzyme, Socket.io, CouchDB, Node.js, Git, Homemade framework development, Photoshop, Illustrator, Premiere Pro, Design, Audio"
    },
    {
